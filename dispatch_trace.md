...
| `transformed_predicates/classify_point_line/prepared_exact_rational_affine` | 5632 | 512 | 0 | 0 | 0 | 0 | 0 | 512 | 0 | 5632 | 0 | 0 | 0 | 0 | 512 | 0 | 0 | 512 | 0 | 0 |
...
| `transformed_predicates/classify_point_line/prepared_exact_rational_affine` | `rational` | `product_sum` | `word-sized` | 512 |
| `transformed_predicates/classify_point_line/prepared_exact_rational_affine` | `rational` | `sub` | `word-sized` | 2048 |
| `transformed_predicates/classify_point_line/prepared_exact_rational_affine` | `rational` | `word-result` | `small-general-fraction` | 2560 |
...
| `transformed_predicates/classify_point_line/prepared_exact_rational_affine` | `rational` | `sub` | 2048 |
| `transformed_predicates/classify_point_line/prepared_exact_rational_affine` | `rational` | `word-result` | 2560 |
...
| `transformed_predicates/classify_point_line/prepared_exact_rational_affine` | 512 | 0 | 0 | 0 |
